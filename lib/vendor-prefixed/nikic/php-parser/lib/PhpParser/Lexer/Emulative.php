...
namespace Onumia\Lib\PhpParser\Lexer;

use Onumia\Lib\PhpParser\Error;
use Onumia\Lib\PhpParser\ErrorHandler;
use Onumia\Lib\PhpParser\Lexer;
use Onumia\Lib\PhpParser\Lexer\TokenEmulator\AsymmetricVisibilityTokenEmulator;
use Onumia\Lib\PhpParser\Lexer\TokenEmulator\AttributeEmulator;
use Onumia\Lib\PhpParser\Lexer\TokenEmulator\EnumTokenEmulator;
use Onumia\Lib\PhpParser\Lexer\TokenEmulator\ExplicitOctalEmulator;
use Onumia\Lib\PhpParser\Lexer\TokenEmulator\MatchTokenEmulator;
use Onumia\Lib\PhpParser\Lexer\TokenEmulator\NullsafeTokenEmulator;
use Onumia\Lib\PhpParser\Lexer\TokenEmulator\PipeOperatorEmulator;
use Onumia\Lib\PhpParser\Lexer\TokenEmulator\PropertyTokenEmulator;
use Onumia\Lib\PhpParser\Lexer\TokenEmulator\ReadonlyFunctionTokenEmulator;
use Onumia\Lib\PhpParser\Lexer\TokenEmulator\ReadonlyTokenEmulator;
use Onumia\Lib\PhpParser\Lexer\TokenEmulator\ReverseEmulator;
use Onumia\Lib\PhpParser\Lexer\TokenEmulator\TokenEmulator;
use Onumia\Lib\PhpParser\Lexer\TokenEmulator\VoidCastEmulator;

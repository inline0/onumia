...
final class UpdaterConfig
{
     ...
     */
    public function __construct(public readonly string $product_name, public readonly string $plugin_slug, public readonly string $plugin_file, public readonly string $current_version, public readonly string $repository_url, public readonly string $asset_regex, public readonly string $asset_version_pattern, public readonly string $public_key, public readonly string $error_code, public readonly string $temp_prefix, callable $repository_url_provider, callable $asset_regex_provider, callable $token_provider, callable $disabled_provider, callable $public_key_provider, callable $icon_url_provider, callable $puc_loader, callable $plugin_basename_provider)
    {

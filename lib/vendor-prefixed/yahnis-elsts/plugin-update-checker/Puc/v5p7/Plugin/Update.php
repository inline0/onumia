...
use Onumia\Lib\YahnisElsts\PluginUpdateChecker\v5p7\Update as BaseUpdate;
if (!class_exists(Update::class, \false)) {
    ...
    class Update extends BaseUpdate
    {
        ...
        protected static $extraFields = array('id', 'homepage', 'tested', 'requires_php', 'upgrade_notice', 'icons', 'filename', 'autoupdate');
        /**

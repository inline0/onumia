...
if (!class_exists(UpdateChecker::class, \false)) {
    abstract class UpdateChecker
    {
        ...
        public function loadTextDomain()
        {
            ...
            $locale = apply_filters('plugin_locale', is_admin() && function_exists('Onumia\Lib\get_user_locale') ? get_user_locale() : get_locale(), $domain);
        ...
        protected function fixSupportedWordpressVersion($update = null)
        {
            ...
            if (function_exists('Onumia\Lib\get_core_updates')) {
        ...
        {
            $this->autoupdateFieldAllowed = \true;
            return $this;
        }
        /**
        ...
        {
            return apply_filters($this->getUniqueName('autoupdate_field_allowed'), $this->autoupdateFieldAllowed, $incomingUpdate);
        }
        /* -------------------------------------------------------------------
        ...
        {
            if (!function_exists('Onumia\Lib\wp_get_installed_translations')) {
                return array();
            }
                ...
                if (!$wp_filesystem->is_dir($newDirectory)) {
                    ...
                    if (is_array($sourceFiles)) {
                        ...
                        if ($allMoved) {
                            ...
                            return new WP_Error('puc-incorrect-directory-structure', sprintf('The directory structure of the update was incorrect. All files should be inside ' . 'a directory named <span class="code">%s</span>, not at the root of the ZIP archive. Plugin Update Checker tried to fix the directory structure, but failed.', esc_html($this->slug)));
                        }
                    }
                }
            }
        ...
        {
            if (class_exists('Onumia\Lib\Debug_Bar', \false) && class_exists('Onumia\Lib\Debug_Bar_Panel', \false) && file_exists(dirname(__FILE__) . '/DebugBar')) {

...
use Onumia\Lib\YahnisElsts\PluginUpdateChecker\v5p7\Utils;
if (!class_exists(BitBucketApi::class, \false)) {
    class BitBucketApi extends Api
    {
        ...
        {
            return sprintf('https://bitbucket.org/%s/%s/get/', $this->username, $this->repository);
        }
        /**
        ...
        public function setAuthentication($credentials)
        {
            ...
            if (is_array($credentials) && !empty($credentials['username']) && !empty($credentials['api_token'])) {
                $this->enableBasicAuth($credentials['username'], $credentials['api_token'], $this->getDownloadBaseUrl());
            }
        }
    }
}

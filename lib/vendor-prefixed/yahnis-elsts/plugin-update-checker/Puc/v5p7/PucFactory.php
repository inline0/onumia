...
use Onumia\Lib\YahnisElsts\PluginUpdateChecker\v5p7\Plugin;
use Onumia\Lib\YahnisElsts\PluginUpdateChecker\v5p7\Theme;
use Onumia\Lib\YahnisElsts\PluginUpdateChecker\v5p7\Vcs;
    ...
    class PucFactory
    {
        ...
        public static function buildUpdateChecker($metadataUrl, $fullPath, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '')
        {
            ...
            if (self::isPluginFile($fullPath)) {
                ...
                throw new \RuntimeException(sprintf('The update checker cannot determine if "%s" is a plugin or a theme. ' . 'This is a bug. Please contact the PUC developer.', esc_html($fullPath)));
            }
        ...
        {
            if (function_exists('Onumia\Lib\wp_normalize_path')) {
        ...
        protected static function isPluginFile($absolutePath)
        {
            ...
            if (function_exists('Onumia\Lib\get_file_data')) {
        ...
        private static function getServiceURI($fullPath)
        {
            ...
            throw new \RuntimeException(sprintf('Unable to locate URI in header of "%s"', esc_html($fullPath)));
        }
        /**

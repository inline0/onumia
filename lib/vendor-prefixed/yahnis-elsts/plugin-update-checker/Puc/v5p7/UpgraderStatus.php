...
if (!class_exists(UpgraderStatus::class, \false)) {
    ...
    class UpgraderStatus
    {
        ...
        private function getThingBeingUpgradedBy($upgrader)
        {
            ...
            $skin = $upgrader->skin;
            if (isset($skin->theme_info) && $skin->theme_info instanceof \Onumia\Lib\WP_Theme) {
                $themeDirectoryName = $skin->theme_info->get_stylesheet();
            } elseif ($skin instanceof \Onumia\Lib\Plugin_Upgrader_Skin) {
                if (isset($skin->plugin) && is_string($skin->plugin) && $skin->plugin !== '') {
                    $pluginFile = $skin->plugin;
                }
            } elseif ($skin instanceof \Onumia\Lib\Theme_Upgrader_Skin) {
        ...
        {
            if (!function_exists('Onumia\Lib\get_plugins')) {

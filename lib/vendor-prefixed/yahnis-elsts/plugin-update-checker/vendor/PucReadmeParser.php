...
if (!\class_exists('Onumia\Lib\PucReadmeParser', \false)) {
    /**
    ...
    class PucReadmeParser
    {
        ...
        {
            // whitelisted chars
            if (\function_exists('Onumia\Lib\user_sanitize')) {
                // bbPress native
        ...
        {
            // not fancy
            $text = \function_exists('Onumia\Lib\wp_strip_all_tags') ? wp_strip_all_tags($text) : \strip_tags($text);
            $text = esc_html($text);
            $text = \trim($text);
            return $text;
        }
        ...
        {
            if (\function_exists('Onumia\Lib\encodeit')) {
                // bbPress native
        ...
        {
            if (\function_exists('Onumia\Lib\decodeit')) {
                // bbPress native

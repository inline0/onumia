...
final class Repository
{
    ...
    public function addWorktree(
        ...
        ?ObjectId $from = null,
        ?string $name = null,
    ): \Onumia\Lib\Pitmaster\Worktree\Worktree {
    ...
    private function pushUpdates(
        ...
        string $url,
        \Onumia\Lib\Pitmaster\Protocol\RefDiscovery $discovery,
        array $updates,
    ...
    private function pushCapabilities(\Onumia\Lib\Pitmaster\Protocol\RefDiscovery $discovery, array $extraCapabilities = []): array
    {
        $capabilities = array_values(array_unique(array_merge(
            \Onumia\Lib\Pitmaster\Protocol\ProtocolV1::DEFAULT_PUSH_CAPABILITIES,
            $extraCapabilities,
        )));

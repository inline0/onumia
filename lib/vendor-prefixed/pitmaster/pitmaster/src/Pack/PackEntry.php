...
final readonly class PackEntry
{
    ...
    public function __construct(public int $packType, public int $uncompressedSize, public int $dataOffset, public int $entryOffset, public ?int $baseOffset = null, public ?string $baseHash = null)
    {
    }

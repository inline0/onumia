...
final class ProtocolV2
{
     ...
     * @var list<string>
     */
    public const DEFAULT_LS_REFS_PREFIXES = ['refs/heads/', 'refs/tags/', 'HEAD'];
    /**
     * @var list<string>
     */
    public const DEFAULT_FETCH_FEATURES = ['thin-pack', 'no-progress', 'ofs-delta'];
    /**
     ...
     */
    public static function buildLsRefsRequest(array $refPrefixes = self::DEFAULT_LS_REFS_PREFIXES, bool $symrefs = \true, bool $peel = \true, bool $unborn = \true, array $serverOptions = []): string
    {
     ...
     * @param list<string> $serverOptions
     */
    public static function buildFetchRequest(array $wants, array $haves = [], array $features = self::DEFAULT_FETCH_FEATURES, bool $done = \true, array $serverOptions = [], ?int $depth = null): string
    {
        if ($wants === []) {
